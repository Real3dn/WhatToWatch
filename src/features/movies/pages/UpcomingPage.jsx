...
/**
 * UpcomingPage displays soon-to-be-released movies with infinite scroll.
 */
  ...
  return (
    <div className="container mx-auto px-4 md:px-12 py-8 flex flex-col gap-6 select-none">
      <div className="border-b border-zinc-800 pb-4">
        ...
        <p className="text-sm text-zinc-400 mt-1">Movies coming soon to theaters.</p>
      </div>
      ...
      {isLoading && items.length === 0 ? (
        ...
        <div className="text-center py-16">
          <p className="text-red-500 font-semibold">Error retrieving upcoming feed. Please refresh.</p>
        </div>
      ) : (
        <>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 justify-items-center">
